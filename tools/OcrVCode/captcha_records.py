...
import testDir.capp.config

IMAGE_HEIGHT = testDir.capp.config.IMAGE_HEIGHT
IMAGE_WIDTH = testDir.capp.config.IMAGE_WIDTH
CHAR_SETS = testDir.capp.config.CHAR_SETS
CLASSES_NUM = testDir.capp.config.CLASSES_NUM
CHARS_NUM = testDir.capp.config.CHARS_NUM

RECORD_DIR = testDir.capp.config.RECORD_DIR
TRAIN_FILE = testDir.capp.config.TRAIN_FILE
VALID_FILE = testDir.capp.config.VALID_FILE
